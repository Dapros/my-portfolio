  ...
  return (
    <>
      <article className="lg:flex md:mt-5 lg:mt-10 relative">
        <section className='border border-primary-o md:w-2/3 lg:w-1/2 mx-auto p-5 rounded-2xl h-fit backdrop-blur-lg lg:absolute lg:top-15 z-1'>
        ...
        <div className='lg:w-2/3'>
          <div className='relative transform lg:translate-x-[50%]'>
            <img 
              ...
              alt=""
            />
            <p className='absolute top-[25%] left-[20%] md:top-[30%] lg:top-[35%] md:left-[40%] py-2 px-3 md:px-5 rounded-full bg-gray-900 text-xs md:text-md shadow'>Hey! thanks for visit my portfolio web site</p>
          </div>
        </div>
      </article>
    </>
